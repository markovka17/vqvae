...
from models.gumbelvae import Model, Criterion, ModelV2
...
def main(args):
    ...
    for epoch in tqdm(range(args.num_epoch)):
        ...
        for train_batch in tqdm(train_dataloader):
            ...
            reconstruction, proposal_distribution, proposal_sample = model(images)
            total_loss, reconstruction_loss, kl = \
                criterion(images, proposal_distribution, proposal_sample, reconstruction)
